...
class ApiHelper
{
    ...
    public static function essential_config_regenerate($db_id)
    {
        ...
        if (isset($db_id) && $db_id > 0) {
            ...
            $acc_categories = $db_name . '.acc_categories';
        ...
        $landing_crm_agent = $dblanding . '.crm_agent';
        $landing_crm_tags = $dblanding . '.crm_tags';
        ...
        $landing_crm_notes = $dblanding . '.crm_notes';
        $landing_crm_lead_source = $dblanding . '.crm_lead_source';
        $landing_crm_lead_social_link = $dblanding . '.crm_lead_social_link';
        $landing_crm_lead_status = $dblanding . '.crm_lead_status';
        ...
        if (isset($db_id) && $db_id > 0) {
            ...
            config(['dbtable.acc_categories' => $acc_categories]);
        ...
        config(['dbtable.crm_tags' => $crm_tags]);
        ...
        config(['dbtable.crm_notes' => $crm_notes]);
